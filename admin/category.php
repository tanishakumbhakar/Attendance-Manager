...
<tr class="active" height="30px">
	<td colspan="5">
	<a href="index.php?option=add_category" ><span class=" glyphicon glyphicon-plus-sign" style="color:black">Add New Category</span></a></td>
</tr>
...
echo "<th><a href='index.php?option=update_category&id=$row[id]'><span class='glyphicon glyphicon-pencil'></span></a>
</th>";
echo "<tr>";
$i++;
}
