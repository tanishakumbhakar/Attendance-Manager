...
<div class="table-responsive">
  <table class="table">
	<tr  class="danger">
	 	<th colspan="8"><a title="Add New Instructor" href="index.php?option=add_instructor"><span class=" glyphicon glyphicon-plus-sign" style="color:black">Add new instructor</span></a></th>
	 </tr>
	<tr class="info">
		<th>Sr. No</th>
		<th>Name</th>
